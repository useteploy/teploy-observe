import{u as i}from"./jsxRuntime.module-BzVfT7zB.js";import{h as d,y as h}from"./index-C6VexdSc.js";const f={mode:"app"},u=[{title:"Getting Started",pages:[{slug:"intro",title:"Introduction",content:`# What is Observe?
...
`),e}function S(){const[o,e]=d("intro");h(()=>{const t=typeof window<"u"?window.location.hash.slice(1):"";t&&e(t)},[]);const l=u.flatMap(t=>t.pages),s=l.find(t=>t.slug===o)||l[0],r=t=>{e(t),typeof window<"u"&&(window.location.hash=t,window.scrollTo(0,0))};return i("div",{class:"docs-layout",children:[i("aside",{class:"docs-sidebar",children:u.map(t=>i("div",{class:"docs-section",children:[i("div",{class:"docs-section-title",children:t.title}),t.pages.map(n=>i("button",{class:`docs-nav-item ${o===n.slug?"docs-nav-item--active":""}`,onClick:()=>r(n.slug),children:n.title},n.slug))]},t.title))}),i("main",{class:"docs-content",children:i("article",{dangerouslySetInnerHTML:{__html:g(s.content)}})})]})}export{f as config,S as default};
