import{u as i}from"./jsxRuntime-BVeGbjfr.js";import{h as d,y as h}from"./hooks-ijpLJSlR.js";import"./index-DLhXU6fD.js";const y={mode:"app"},u=[{title:"Getting Started",pages:[{slug:"intro",title:"Introduction",content:`# What is Observe?
...
\`\`\`
`},{slug:"replay-sdk",title:"Session Replay SDK",content:`# Session Replay
...
`),e}function E(){const[n,e]=d("intro");h(()=>{const t=typeof window<"u"?window.location.hash.slice(1):"";t&&e(t)},[]);const l=u.flatMap(t=>t.pages),s=l.find(t=>t.slug===n)||l[0],r=t=>{e(t),typeof window<"u"&&(window.location.hash=t,window.scrollTo(0,0))};return i("div",{class:"docs-layout",children:[i("aside",{class:"docs-sidebar",children:u.map(t=>i("div",{class:"docs-section",children:[i("div",{class:"docs-section-title",children:t.title}),t.pages.map(o=>i("button",{class:`docs-nav-item ${n===o.slug?"docs-nav-item--active":""}`,onClick:()=>r(o.slug),children:o.title},o.slug))]},t.title))}),i("main",{class:"docs-content",children:i("article",{dangerouslySetInnerHTML:{__html:g(s.content)}})})]})}export{y as config,E as default};
